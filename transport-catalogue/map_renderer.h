...
class SvgMaker {
    public:
    template <typename PointInputIt>
    SphereProjector CollectCordins(PointInputIt points_begin, PointInputIt points_end,
                    double max_width, double max_height, double padding)
    {
        return {points_begin, points_end, max_width, max_height, padding};
    }
    ...
    svg::Circle MakeLable(const SvgOption& options, const render::SphereProjector &svg_cordinates, const geo_math::Coordinates& point);
